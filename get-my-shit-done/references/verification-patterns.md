...
Run these checks against each must-have artifact. Aggregate results into VERIFICATION.org.
...
**@~/.claude/get-my-shit-done/references/checkpoints.md** → `<automation_reference>` section
