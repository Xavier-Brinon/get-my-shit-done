...
:diataxis_rationale: Reader (human) follows the generated USER-SETUP.org to accomplish the specific goal of configuring external services — environment variables, dashboard steps, and verification commands.
:END:
...
Template for ~.planning/phases/XX-name/{phase}-USER-SETUP.org~ - human-required configuration that Claude cannot automate.
...
#+begin_src org
#+title: Phase {X}: User Setup Required
#+generated: [YYYY-MM-DD Day]
#+phase: {phase-name}
#+status: Incomplete
#+startup: indent
#+options: toc:2 num:nil ^:{}
...
Generate ~{phase}-USER-SETUP.org~ when plan frontmatter contains ~user_setup~ field.

*Trigger:* ~user_setup~ exists in PLAN.org frontmatter and has items.

*Location:* Same directory as PLAN.org and SUMMARY.org.

*Timing:* Generated during execute-plan.md after tasks complete, before SUMMARY.org creation.

-----

** Frontmatter Schema

In PLAN.org, ~user_setup~ declares human-required configuration:
...
*USER-SETUP.org contains ONLY what Claude literally cannot do.*
...
<stripe_example>
#+begin_src org
#+title: Phase 10: User Setup Required
#+generated: [2025-01-14 Tue]
...
<supabase_example>
#+begin_src org
#+title: Phase 2: User Setup Required
#+generated: [2025-01-14 Tue]
...
<sendgrid_example>
#+begin_src org
#+title: Phase 5: User Setup Required
#+generated: [2025-01-14 Tue]
...
*Naming:* ~{phase}-USER-SETUP.org~ matches the phase number pattern.
