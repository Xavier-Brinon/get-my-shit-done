...
:diataxis_rationale: Reader consults the generated FEATURES.org to look up the feature landscape — table stakes, differentiators, anti-features, and MVP scope — for the researched project domain.
:END:
...
Template for ~.planning/research/FEATURES.org~ — feature landscape for the project domain.
...
- Should align with the Core Value from PROJECT.org
