...
:diataxis_rationale: Reader consults the generated STACK.org to look up recommended technologies, supporting libraries, and alternatives considered for the researched project domain.
:END:
...
Template for ~.planning/research/STACK.org~ — recommended technologies for the project domain.
