...
:diataxis_rationale: Reader consults the generated SUMMARY.org to look up consolidated research findings and roadmap implications for the project domain before planning phases.
:END:
...
Template for ~.planning/research/SUMMARY.org~ — executive summary of project research with roadmap implications.
...
[Summary from STACK.org — 1-2 paragraphs]
...
[Summary from ARCHITECTURE.org — 1 paragraph]
...
**Addresses:** [features from FEATURES.org]
**Avoids:** [pitfall from PITFALLS.org]

### Phase 2: [Name]
**Rationale:** [why this order]
**Delivers:** [what this phase produces]
**Uses:** [stack elements from STACK.org]
...
- Link to detailed docs (STACK.org, FEATURES.org, etc.)
