...
:diataxis_rationale: Reader consults the generated PITFALLS.org to look up domain-specific failure modes, integration gotchas, and avoidance strategies before implementing.
:END:
...
Template for ~.planning/research/PITFALLS.org~ — common mistakes to avoid in the project domain.
