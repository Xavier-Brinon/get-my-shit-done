...
:diataxis_rationale: Reader consults REQUIREMENTS.org to look up requirement IDs, their status, and traceability to phases — authoritative checklist of what "done" means.
:END:
...
Template for ~.planning/REQUIREMENTS.org~ — checkable requirements that define "done."

<template>

#+begin_src org
#+title: Requirements: [Project Name]
#+defined: [YYYY-MM-DD Day]
#+core_value: [from PROJECT.org]
#+startup: indent
#+options: toc:2 num:nil ^:{}
...
*Categories:*
- Derive from research FEATURES.org categories
...
#+begin_src org
#+title: Requirements: CommunityApp
#+defined: [2025-01-14 Tue]
