...
:diataxis_rationale: Reader consults the generated DISCOVERY.org to look up the primary recommendation, alternatives considered, and key findings for a specific library or technology choice.
:END:
...
Template for ~.planning/phases/XX-name/DISCOVERY.org~ - shallow research for library/option decisions.

*Purpose:* Answer "which library/option should we use" questions during mandatory discovery in plan-phase.

For deep ecosystem research ("how do experts build this"), use ~/gmsd:research-phase~ which produces RESEARCH.org.
...
Scope: [Boundaries]
Output: DISCOVERY.org with recommendation
</discovery_objective>
...
<output_structure>
Create ~.planning/phases/XX-name/DISCOVERY.org~:
...
*When to use RESEARCH.org instead:*
- Niche/complex domains (3D, games, audio, shaders)
- Need ecosystem knowledge, not just library choice
- "How do experts build this" questions
- Use ~/gmsd:research-phase~ for these
</guidelines>
</output>
