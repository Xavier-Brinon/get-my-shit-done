...
:diataxis_rationale: Reader consults the generated CONCERNS.org to look up known bugs, tech debt, and risks before making changes to the codebase.
:END:
...
Template for ~.planning/codebase/CONCERNS.org~ - captures known issues and areas requiring care.
