...
:diataxis_rationale: Reader consults MILESTONES.org to look up what was shipped, stats, and git ranges for completed milestones.
:END:
...
Add this entry to ~.planning/MILESTONES.org~ when completing a milestone:
...
<structure>
If MILESTONES.org doesn't exist, create it with header:
