...
:diataxis_rationale: Reader consults the generated RESEARCH.org to look up standard stack, architecture patterns, and pitfalls for a domain; explanation sections cover rationale for why patterns are recommended.
:END:
...
Template for ~.planning/phases/XX-name/{phase_num}-RESEARCH.org~ - comprehensive ecosystem research before planning.
...
#+begin_src org
#+title: Phase [X]: [Name] - Research
#+researched: [YYYY-MM-DD Day]
...
*CRITICAL:* If CONTEXT.org exists from /gmsd:discuss-phase, copy locked decisions here verbatim. These MUST be honored by the planner.

*** Locked Decisions
[Copy from CONTEXT.org ~** Decisions~ section - these are NON-NEGOTIABLE]
- [Decision 1]
- [Decision 2]

*** Claude's Discretion
[Copy from CONTEXT.org - areas where researcher/planner can choose]
- [Area 1]
- [Area 2]

*** Deferred Ideas (OUT OF SCOPE)
[Copy from CONTEXT.org - do NOT research or plan these]
- [Deferred 1]
- [Deferred 2]

*If no CONTEXT.org exists:* Write "No user constraints - all decisions at Claude's discretion"
</user_constraints>
...
*** Component Interaction (Optional)

#+begin_src mermaid :file research-architecture.png :exports results
flowchart TD
    subgraph Frontend
        UI["UI Components"]
        State["State Store"]
...
#+begin_src org
#+title: Phase 3: 3D City Driving - Research
#+researched: [2025-01-20 Mon]
...
*Structure:*
- Use XML tags for section markers (matches GMSD templates)
...
- RESEARCH.org loaded as @context reference in PLAN.org
...
*After creation:*
- File lives in phase directory: ~.planning/phases/XX-name/{phase_num}-RESEARCH.org~
