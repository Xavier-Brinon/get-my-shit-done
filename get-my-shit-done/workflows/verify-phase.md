...
<required_reading>
@~/.claude/get-my-shit-done/references/verification-patterns.md
@~/.claude/get-my-shit-done/templates/verification-report.org
</required_reading>
...
```bash
PHASE_DATA=$(node ~/.claude/get-my-shit-done/bin/gmsd-tools.cjs roadmap get-phase "${phase_number}" --raw)
```
...
See ~/.claude/get-my-shit-done/templates/verification-report.org for complete template.
</step>
