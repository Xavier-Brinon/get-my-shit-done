...
<required_reading>
@~/.claude/get-my-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node ~/.claude/get-my-shit-done/bin/gmsd-tools.cjs init resume)
```
...
📋 [N] pending todos — /gmsd:check-todos to review
...
- **Plan phase** → Show command for user to run after clearing:
  ...
  **Also available:**
  - `/gmsd:discuss-phase [N]` — gather context first
  - `/gmsd:research-phase [N]` — investigate unknowns
