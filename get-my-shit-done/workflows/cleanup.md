...
```bash
node ~/.claude/get-my-shit-done/bin/gmsd-tools.cjs commit "chore: archive phase directories from completed milestones" --files .planning/milestones/ .planning/phases/
```
