...
**Delegate archival to gmsd-tools:**

```bash
ARCHIVE=$(node ~/.claude/get-my-shit-done/bin/gmsd-tools.cjs milestone complete "v[X.Y]" --name "[Milestone Name]")
```
...
**If doesn't exist:** Create from template at `~/.claude/get-my-shit-done/templates/retrospective.org`.
