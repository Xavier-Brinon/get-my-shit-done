...
See ~/.claude/get-my-shit-done/templates/discovery.org `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
1. **Scope the discovery** using ~/.claude/get-my-shit-done/templates/discovery.org:
...
Use ~/.claude/get-my-shit-done/templates/discovery.org.
...
1. Discuss phase context (/gmsd:discuss-phase [current-phase])
2. Create phase plan (/gmsd:plan-phase [current-phase])
