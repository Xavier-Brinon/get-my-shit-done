...
const MODEL_PROFILES = {
  'gmsd-planner':              { quality: 'opus', balanced: 'opus',   budget: 'sonnet' },
  'gmsd-roadmapper':           { quality: 'opus', balanced: 'sonnet', budget: 'sonnet' },
  'gmsd-executor':             { quality: 'opus', balanced: 'sonnet', budget: 'sonnet' },
  'gmsd-phase-researcher':     { quality: 'opus', balanced: 'sonnet', budget: 'haiku' },
  'gmsd-project-researcher':   { quality: 'opus', balanced: 'sonnet', budget: 'haiku' },
  'gmsd-research-synthesizer': { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku' },
  'gmsd-debugger':             { quality: 'opus', balanced: 'sonnet', budget: 'sonnet' },
  'gmsd-codebase-mapper':      { quality: 'sonnet', balanced: 'haiku', budget: 'haiku' },
  'gmsd-verifier':             { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku' },
  'gmsd-plan-checker':         { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku' },
  'gmsd-integration-checker':  { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku' },
};
...
function output(result, raw, rawValue) {
  if (raw && rawValue !== undefined) {
    ...
    if (json.length > 50000) {
      const tmpPath = path.join(require('os').tmpdir(), `gmsd-${Date.now()}.json`);
