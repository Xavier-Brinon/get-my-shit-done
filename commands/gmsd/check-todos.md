...
<execution_context>
@~/.claude/get-my-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@~/.claude/get-my-shit-done/workflows/check-todos.md`.
