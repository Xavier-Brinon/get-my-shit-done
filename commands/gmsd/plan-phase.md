...
**Orchestrator role:** Parse arguments, validate phase, research domain (unless skipped), spawn gmsd-planner, verify with gmsd-plan-checker, iterate until pass or max iterations, present results.
</objective>
...
<process>
Execute the plan-phase workflow from @~/.claude/get-my-shit-done/workflows/plan-phase.md end-to-end.
